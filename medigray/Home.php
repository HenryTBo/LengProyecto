...
<body>
            ...
            <div class="row align-items-center justify-content-start hero-content-row">
                <div class="col-lg-7 text-start hero-text-column">
                    ...
                    <div class="mt-5">
                        ...
                        <a href="nosotros.html" class="btn btn-outline-light btn-lg rounded-pill px-5 py-3 hero-button">
                            <i class="bi bi-info-circle me-2"></i>Conózcanos
                        </a>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="cta-section p-5 text-white">
